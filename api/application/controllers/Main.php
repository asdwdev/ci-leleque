...
class Main extends CI_Controller
{
    ...
    public function saveProfile()
    {
        ...
        // Validasi nomor HP: jika tidak kosong, harus angka
        if (!empty($nomorHP) && !is_numeric($nomorHP)) {
            echo "<script>
        ...
        // Inisialisasi CURL untuk update data
        $cUrl = curl_init();
        ...
        $result = array(
            ...
            CURLOPT_POSTFIELDS => http_build_query(array(
                'id' => $id,
                'nama' => $nama,
                'nomorHP' => $nomorHP, // Nomor HP kosong tetap diteruskan
                'email' => $email,
